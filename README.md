...
### from. [김유정](https://github.com/YuChocopie) (Android Developer)
...
### from. [이동영](https://github.com/O-O-wl) (iOS Developer, 마이리얼트립)

> - 사람들과 이야기를 나누고, 사람들과 즐겁게 소통하는 능력이 있다.
> - 개구쟁이처럼 장난도 많이 치지만, 프로젝트를 진행할 때는 노련한 모습을 보여줍니다.✨
> - 스터디, 세미나, 프로젝트 협업에서 책임감을 가지고 임하는 모습이 보여줍니다.😮
> - 많은 사람들이 주저할 때, 추친력있게 시작할 줄 압니다.
> - 주변 사람을 하나하나 다 신경 쓰고, 모두가 즐겁게 참여할 수 있게 많은 노력을 합니다.

### from. [김대윤](https://github.com/niceoasi) (iOS Developer, NAVER)

> - 본받을 점이 매우 많은 뛰어난 친구입니다.
>   - 좀 더 원활한 협업을 위해, Backend를 공부하고 다른 분야의 공부하는 것을 주저하지 않는 친구입니다.
>   - 넓은 시야를 갖고 있어, 프로젝트르 진행 할 때, 관련 Spec에 필요한 기술 등을 빠르게 결정 할 수 있는 친구입니다.
>   - 추진력이 좋아, 한번 생각한 일들을 바로바로 시작하는 친구입니다.
>   - 관심있는 분야에 집중 하고, 이를 통해 좋은 성과를 내는 친구입니다.
> - 주변에 좋은 영향력을 행사할 수 있는 친구입니다.
>   - 새로운 기술을 단순히 배우는 것을 뛰어 넘어, 좋은 기술들을 주변에 전파 하는 친구입니다.
>   - 여러 커뮤니티 활동의 운영진을 하면서 구성원들이 같이 발전할 수 있도록 노력하는 친구입니다.
>   - 협업을 하면서 본인의 주장을 고집하지 않고, 함께 생각하여 좀 더 나은 방향으로 갈 수 있게 노력하는 친구입니다.
...
### 이모지키보드
키보드 이모지 익스텐션 앱
- 기간 : 2017.12 ~ 2017.10 (디자인과 기능을 수정하여 v2 출시예정)
- 소속 : 개인프로젝트
- 역할 : iOS 앱 개발
- 사용기술 : swift, keyboard extension
...
### 전역일계산기
군대 전역일을 계산
- 기간 : 2017.01 ~ 2018.10 (전역일이 변경된김에 디자인도 개선하여 배포 예정)
- 소속 : 개인프로젝트
- 역할 : iOS 앱 개발
